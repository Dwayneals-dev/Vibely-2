      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid gap-8 md:grid-cols-2 md:items-end max-w-5xl mx-auto">
          {testimonials.map((testimonial, index) => (
            ...
            >
              {/* Screenshot — fixed size, in normal flow, nudged outward */}
              <div className={`hidden md:block rounded-xl overflow-hidden border border-white/[0.06] shadow-2xl h-[280px] ${index === 0 ? '-ml-6' : '-mr-6 ml-auto'}`}>
                <img
              ...
              {/* Review card — overlaps screenshot upward */}
              <div className="relative z-10 md:-mt-20 mx-4 sm:mx-6 md:mx-8">
                {/* Glow on hover */}
                ...
                <div className="relative glass-card rounded-2xl p-7 hover:border-white/10 transition-all duration-300 flex flex-col md:h-[320px]">
                  {/* Quote icon */}
